...
const Markdown = ({ defaultValue, setText }: MarkdownPropTypes) => {
  ...
  useEffect(() => {
    setValue({ text: defaultValue, end: -1, start: -1 });
  }, [defaultValue]);
  useEffect(() => {
  ...
  return (
    <div className="my-3 shadow-md h-full flex flex-col">
      <div className="flex justify-between items-center bg-[#F9F9F9] py-2">
        <div className="flex">
          <div>
            <button
              type="button"
